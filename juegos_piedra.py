...
class PiedraPapelTijeraApp:
    def __init__(self, root): #Definimos el metodo
        ...
        self.piedra_btn = tk.Button(self.botones_frame, image=self.piedra_img, command=lambda: self.jugar("Piedra"))
        self.piedra_btn.grid(row=0, column=0, padx=10)

        self.papel_btn = tk.Button(self.botones_frame, image=self.papel_img, command=lambda: self.jugar("Papel"))
